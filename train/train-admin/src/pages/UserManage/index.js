...
import { Table, Input, Col, Row, Select, InputNumber, DatePicker, AutoComplete, Cascader, Divider, Button, Radio, message, Tag, Modal, Space } from 'antd';
...
export default function Index() {
    const [data, setData] = useState([]);//train id
        ...
        <div>
            ...
            >
                ...
                {/* <Radio.Group onChange={onChange} defaultValue="a" style={{ marginTop: 16 }}>
                    <Radio.Button value={2} disabled={roleId === 2} >管理员</Radio.Button>
                    <Radio.Button value={3} disabled={roleId === 3} >普通用户</Radio.Button>
                    <Radio.Button value={4} disabled={roleId === 4} >火车管理员(负责车次、座位)</Radio.Button>
                    <Radio.Button value={5} disabled={roleId === 5} >销售管理员(负责订单管理)</Radio.Button>
                </Radio.Group> */}
