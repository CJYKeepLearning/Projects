...
import { Table, Input, Col, Row, Select, InputNumber, DatePicker, AutoComplete, Cascader, Divider, Button, TimePicker, message } from 'antd';
import { gettrainlist, deletetrainlist, addtrainlist } from './trainmanage_redux';
...
export default function Index() {
    ...
    // let addfunction = (e) => { console.log(trainId, startStation, endStation, startTime, endTime) };
    // let deletefunction = (e) => { dispatch(deletetrainlist(e)) };
    let addfunction = () => {
