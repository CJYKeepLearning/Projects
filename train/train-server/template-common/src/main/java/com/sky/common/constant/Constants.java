...
public class Constants {
    ...
    public static final String APPLICATION_NAME = "train";
     ...
     * 登录用户 redis key
     */
    public static final String TOKEN_REDIS_KEY = APPLICATION_NAME + ":token:";


    /**
     * refresh_token redis key
     */
    public static final String REFRESH_TOKEN_REDIS_KEY = APPLICATION_NAME +":refresh_token:";

    /**
     * 通过userId存redis的key
     */
    public static final String USER_INFO_REDIS_KEY =APPLICATION_NAME + "user:";
