...
import com.sky.framework.security.filter.TokenAuthenticationFilter;
...
import com.sky.framework.service.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/ticket/city/**").permitAll()
                .antMatchers("/train/info/**").permitAll()
                .antMatchers("/ticket/info/**").permitAll()
